...
with open('D:/HMS/HMS/apps/frontend/components/HotelCard.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

print('✅ HotelCard.tsx successfully updated with all Booking.com enhancements!')
print('   - Urgency signals (low availability warnings)')
print('   - Social proof (viewing count, bookings today)')
print('   - Trust badges (free cancellation)')
print('   - Price transparency (original price, discounts, taxes)')
print('   - Key amenity icons (WiFi, Parking, Breakfast)')
print('   - Enhanced ratings with review count')
print('   - HOT DEAL badges for big discounts')
